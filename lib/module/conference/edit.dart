...
class _ConferenceEditState extends State<ConferenceEdit> {
  ...
  void initState() {
    ...
    nameController.text = widget.conference.name;
    dateTimeController.text =
        DateFormat("dd/MM/yyyy hh:mm a").format(widget.conference.dateTime);
    descController.text = widget.conference.desc;
  }
          ...
          TextButton(
            onPressed: () async {
              if (validate()) {
                ...
                final result = await ConferenceService().edit(
